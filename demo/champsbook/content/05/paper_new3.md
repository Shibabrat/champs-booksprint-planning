...
<figcaption style="text-align:center;font-size:14px"><em>Comparing the TP, TPCD, DCNC methods for the coupled quartic Hamiltonian.</em></figcaption><a id="allinone_coupled"></a>


![Comparing the TPCD method for the three Hamiltonians.](allinone_tpcd.jpg)
<figcaption style="text-align:center;font-size:14px"><em>Comparing the TPCD method for the three Hamiltonians.</em></figcaption><a id="allinone_newmethod"></a>
